...
local Window = Rayfield:CreateWindow({
   Name = "5HDGB MAINCHEATV1",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "LORMAT BOBO...",
   LoadingSubtitle = "LORMAT BOBO",
   ShowText = "LORMAT BOBO", -- for mobile users to unhide rayfield, change if you'd like
   ...
   ConfigurationSaving = {
      ...
      FileName = "LORMAT BOBO"
   },
 
   Discord = {
      Enabled = true, -- Prompt the user to join your Discord server if their executor supports it
      Invite = "discord.gg/REDBOYZ", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      Title = "LORMAT BOBO",
      Subtitle = "LORMAT BOBO",
      Note = "LORMAT BOBO", -- Use this to tell the user how to get a key
      FileName = "LORMAT BOBO", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = "LORMAT BOBO" -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local Button = MAINTab:CreateButton({
   Name = "INFINITE YIELD [LORMAT BOBO]",
   Callback = function()
...
local Button = MAINTab:CreateButton({
   Name = "HITBOX EXPANDER [LORMAT BOBO]",
   Callback = function()
...
-- Rayfield button
SPAWNGUNTab:CreateButton({
    Name = "ALL CITY MEDKIT [LORMAT BOBO]",
    Callback = function()
   local args = {
    [1] = "MEDKIT",
    [2] = -1000000
...
-- Rayfield button
SPAWNGUNTab:CreateButton({
    Name = "ALL CITY Glock-19 [LORMAT BOBO]",
    Callback = function()
        local args = {
    [1] = "Glock-19",
    [2] = -1000000
...
-- Rayfield button
SPAWNGUNTab:CreateButton({
    Name = "ALL CITY AK-47 [LORMAT BOBO]",
    Callback = function()
        local args = {
    [1] = "AK-47",
    [2] = -1000000
...
-- Rayfield button
SPAWNGUNTab:CreateButton({
    Name = "ALL CITY BANDAGES [LORMAT BOBO]",
    Callback = function()
        local args = {
    [1] = "BANDAGES",
    [2] = -1000000
